...
public class MatrixCalculatorGUI extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7534667990618549964L;
	...
	public Component createComponents() {
		...
		JButton btnBsA = new JButton("B - A = C");
		JButton btnAdB = new JButton("A / B = C");
		JButton btnBdA = new JButton("B / A = C");
		JButton btnAdjA = new JButton("adjoint(A) = C");
		JButton btnAdjB = new JButton("adjoint(B) = C");
		JButton btnInvA = new JButton("inverse(A) = C");
		JButton btnInvB = new JButton("inverse(B) = C");
		JButton btnTrnsA = new JButton("transpose(A) = C");
		JButton btnTrnsB = new JButton("transpose(B) = C");
		...
		btnAsB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(SubtractMatrix(ReadInMatrix(taA), ReadInMatrix(taB)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
		...
		btnAdB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(DivideMatrix(ReadInMatrix(taA), ReadInMatrix(taB)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
		...
		btnBdA.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(DivideMatrix(ReadInMatrix(taB), ReadInMatrix(taA)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
		...
		btnBsA.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(SubtractMatrix(ReadInMatrix(taB), ReadInMatrix(taA)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
		...
		btnAdjB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(Adjoint(ReadInMatrix(taB)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
		...
		btnTrnsB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					DisplayMatrix(Transpose(ReadInMatrix(taB)), taC);
				} catch (Exception e) {
					System.err.println("Error: " + e);
				}
			}
	...
	public static void main(String[] args) {
		...
		MatrixCalculatorGUI app = new MatrixCalculatorGUI();
...
//--------------------------------------------------------------
	...
	public float[][] DivideMatrix(float[][] a, float[][] b) throws Exception {
		int tms = a.length;
		int tmsB = b.length;
		if (tms != tmsB) {
			statusBar.setText("Matrix Size Mismatch");
